...
## [0.2.0] — Bob Adaptation

### Changed
- **Adapted for IBM Bob:** All references to Claude Code and Claude have been updated to work with IBM Bob
- Updated `SKILL.md` to use `${BOB_SKILL_DIR}` instead of `${CLAUDE_SKILL_DIR}`
- Updated all documentation to reference Bob instead of Claude
- Modified installation instructions for Bob users

### Added
- Attribution to original project: [claude-video](https://github.com/bradautomates/claude-video) by Bradley Bonanno ([@bradautomates](https://github.com/bradautomates))
- Bob-specific setup instructions in README.md
- Metadata in SKILL.md crediting original author and repository

### Note
This is a Bob-compatible fork of the original claude-video skill. All core functionality remains the same, with interface adaptations for IBM Bob. The original MIT license is maintained.
